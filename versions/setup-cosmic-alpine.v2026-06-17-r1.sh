...
#  13. Enable and start all required OpenRC services
#  14. Remove competing / broken display managers from runlevel
#  15. Print post-install instructions (reboot)
#
# Usage:
...
${C_BOLD}${C_CYN}== setup-cosmic-alpine.sh complete ==${C_RST}
  ...
  Browser:        ${BROWSER_PKG:-none}

${C_BOLD}Next steps${C_RST}
  1. ${C_BOLD}reboot${C_RST} - 'reboot' or 'doas reboot'
